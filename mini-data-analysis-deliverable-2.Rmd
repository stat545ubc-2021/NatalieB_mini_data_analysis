...
3. Making a ridge plot of acclimation temperatures
```{r warning=FALSE}
...
```
which acclimation temperature yielded fish with the highest thermal tolerance?
```{r}
